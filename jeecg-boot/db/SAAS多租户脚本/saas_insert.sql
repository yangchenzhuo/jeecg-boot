...
# 新增默认系系统租户
INSERT INTO `jeecg-boot`.`sys_tenancy_info`(`id`, `create_by`, `create_time`, `update_by`, `update_time`, `domain`, `tenancy_name`, `tenancy_info`, `user_limit`, `expire`, `tenancy_type`) VALUES ('4e8f11dafee143938b0ef9215cccd9a4', 'admin', '2020-02-25 11:35:27', 'admin', '2020-02-25 11:36:18', 'www.aaa.com', '系统默认租户', '系统默认租户', 0, NULL, 'sys');